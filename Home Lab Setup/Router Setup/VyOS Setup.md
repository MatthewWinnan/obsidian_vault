...
1. **Configure PPPoE on WAN Interface**: Use my router's interface to enter PPPoE credentials and establish a connection to my ISP. See [[Configuring PPPoE]] for details.
...
3. **Enable NAT**: Ensure #NAT is enabled on my router to allow multiple devices to share the Internet connection. See [[Configuring NAT]] for details.
...
## Reference Material
- [[RFC Archive]] - Relevant RFCs for networking protocols
